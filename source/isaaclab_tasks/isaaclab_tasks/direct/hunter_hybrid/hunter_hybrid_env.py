...
coordinates = np.genfromtxt('/home/kevin/IsaacLab_DRL/source/isaaclab_tasks/isaaclab_tasks/direct/hunter_hybrid/Austin_centerline2.csv', delimiter = ',')
...
class HunterHybridEnv(DirectRLEnv):
    ...
    def _setup_scene(self):
        ...
        colors = [(0.0, 0.0, 1.0, 1) for _ in range(num_points)]  # Blue color
